...
s≠ts≠t; we demand s≠ts≠t to prevent directed loops in the overlap graph
...
for sample1 in samples:
    dna1 = sample1['sequence']
    for sample2 in samples:
        dna2 = sample2['sequence']
        if sample1['id'] != sample2['id'] and dna2.startswith(dna1[-K:]):
            print sample1['id'], sample2['id']
